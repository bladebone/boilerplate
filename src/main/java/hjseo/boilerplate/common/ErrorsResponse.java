...
public class ErrorsResponse {
    ...
    public static ErrorsResponse create(Errors errors, MessageSource messageSource, Locale locale) {

        List<SimpleErrorResponse> errorResponseList = errors.getFieldErrors()
                .stream()
                .map(e -> SimpleErrorResponse.createByError(e, messageSource, locale))
